        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
                ...
                onPressed: () {
                  Navigator.push(context, ScaleRoute(page: ShoppingList()));
                })
          ],
        ),
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              PreferredSize(
                ...
                child: TabBar(
                  labelColor: Color(0xFF880E45),
                  indicatorColor: Color(0xFF880E45),
...
class AddTolistMenu extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Center(
      child: Row(
...
class DetailContentMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Text(
        'Lorem ipsum, or lipsum as it is sometimes known, is ic_popular_food_1 text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero\'s De Finibus Bonorum et Malorum for use in a type specimen book.',
        style: TextStyle(
            fontSize: 14.0,
