...
class listItem extends StatelessWidget {
  ...
  listItem({
    ...
    @required this.productlistQuantity,
  }) : super(key: key);
...
class listIconWithBadge extends StatelessWidget {
  int counter = 3;
...
class AddTolistMenu extends StatelessWidget {
  ...
  AddTolistMenu(this.productCounter);
